...
namespace wfdbig
{
    public partial class P104 : Form
...

    {
        ...
        public P104()
        {
            ...
            this.MouseDown += P104_MouseDown;
            this.MouseMove += P104_MouseMove;
            this.MouseUp += P104_MouseUp;
        ...
        private void P104_Load(object sender, EventArgs e)
        {
        ...
        private void P104_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        private void P104_MouseMove(object sender, MouseEventArgs e)
        {
            if (isDragging)
            {
        ...
        private void P104_MouseUp(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                isDragging = false;
