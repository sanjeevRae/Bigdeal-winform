...
namespace wfdbig
{
...

    {
        ...
        public P36()
        {
            ...
            this.MouseDown += P36_MouseDown;
            this.MouseMove += P36_MouseMove;
            this.MouseUp += P36_MouseUp;
        ...
        private void P36_Load(object sender, EventArgs e)
        {
        ...
        private void P36_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        private void P36_MouseMove(object sender, MouseEventArgs e)
        {
            if (isDragging)
            {
        ...
        private void P36_MouseUp(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                isDragging = false;
